...
public class Activity_4_3 {
	...
	public static void main(String[] args) {
        ...
        System.out.println("The text in the third header is: " + thirdHeader);
 
        //Find the fifth header and get it's colour
        String fifthHeaderColour = driver.findElement(By.xpath("//h5")).getCssValue("color");
        System.out.println("The colour of the fifth header is: " + fifthHeaderColour);
        ...
        System.out.println("The classes for the Violet button are: " + violetButtonClasses);
